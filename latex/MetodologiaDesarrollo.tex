...
\begin{quotation}[General]{Dwight D. Eisenhower (1890--1969)}
Los planes no sirven de nada, pero la planificación lo es todo.
\end{quotation}
...
\begin{enumerate}
    ...
    \item \textbf{Automatización de experimentos.} Desarrollo de los nodos de medición en C++ (\texttt{data\_measure.cpp} y \texttt{data\_measure\_dynamic.cpp}) que automatizan el envío de objetivos y la recogida de métricas.
