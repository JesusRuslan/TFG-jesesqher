...
El paquete \texttt{turtlebot4\_cpp\_tutorials} contiene un único nodo llamado \texttt{turtlebot4\_first\_cpp\_node}, desarrollado como primer contacto con la programación de nodos ROS2 en C++ y como verificación del entorno de simulación.
