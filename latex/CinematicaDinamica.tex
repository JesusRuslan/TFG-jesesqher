...
\begin{quotation}[Estadístico]{George E. P. Box (1919--2013)}
...
El firmware del Create3 impone una serie de restricciones sobre el movimiento del robot que tienen impacto directo en la planificación y ejecución de trayectorias. Estas restricciones son configurables a través del nodo ROS2 \texttt{motion\_control} mediante el parámetro \texttt{safety\_override}\cite{create3_docs}\cite{create3_sim}.
...
Durante su ejecución, el Create3 combina tres fuentes de datos para producir su estimación odométrica\cite{create3_docs}:
