...
\begin{quotation}[Físico teórico]{Richard P. Feymann (1918--1988)}
...
En este proyecto, TurtleBot 4 se utiliza como laboratorio rodante: el entorno de simulación permite probar algoritmos, parámetros y configuraciones de forma segura, mientras que el robot real permite validar que el comportamiento en el mundo físico es coherente con el esperado en simulación. Esta combinación entre simulación y hardware permite profundizar en aspectos como la robustez de la navegación, la influencia de los sensores y la calidad del mapa sobre el rendimiento global del sistema.
