...
\begin{quotation}[Ingeniero]{Werner von Braun (1912--1977)}
...
\begin{itemize}
    ...
    \item \textbf{Actions:} similar a los services pero para tareas de larga duración. Permiten enviar un objetivo, recibir retroalimentación periódica sobre el progreso y obtener el resultado final cuando la tarea termina. En este proyecto se utilizan para enviar objetivos de navegación a Nav2.
\end{itemize}
