...
\item Funcionalidad 1: Iniciar Sesión. Ver Tabla \ref{tab:valor1AportadoIteracion2}.
\item Funcionalidad 2: Registro. Ver Tabla \ref{tab:valor2AportadoIteracion2}.
...
\textbf{Propuesta}&Se pretende desarrollar la funcionalidad de iniciar sesión.\\
\midrule
\textbf{Valor}&El valor aportado es iniciar sesión en la aplicación.\\
...
\textbf{Riesgos}&El fallo en el proceso de guardar el token de acceso generado al iniciar sesión.\\
\textbf{Deuda técnica}&Se ha elegido la solución más factible para el desarrollo de la misma.\\
	\end{coolTable}
	\caption{Análisis de valor aportado 0001\label{tab:valor1AportadoIteracion2}}
\end{table*}
%----------------------------------------------------------------------------------------------------------
\begin{table*}[htb]
	\centering
...
\textbf{Propuesta}&Se pretende desarrollar la funcionalidad de registrar sesión.\\
\midrule
\textbf{Valor}&El valor aportado es poder registrarse en la aplicación.\\
\textbf{Coste}&Se requiere la participación de ambos miembros del equipo desarrollador para llevar a cabo la implementación.\\
\textbf{Opciones}&Esta funcionalidad tiene un valor prioritario en la aplicación.\\
\textbf{Riesgos}&La posibilidad de no poder realizar el registro de usuario de forma satisfactoria.\\
\textbf{Deuda técnica}&Se ha elegido la solución más factible para el desarrollo de la misma.\\
	\end{coolTable}
	\caption{Análisis de valor aportado 0002\label{tab:valor2AportadoIteracion2}}
\end{table*}
%----------------------------------------------------------------------------------------------------------
...
\section{Diseño}
Durante esta iteración no se ha realizado ninguna modificación al diseño de la aplicación, todos los modelos se han mantenido con la misma estructura y atributos así como relación.

Esto es comparable en la siguiente figura. \ref{fig:diseno02}.

\begin{figure}[htbp]
\begin{center}

\includegraphics[width=\textwidth]{figures/UML-iteracion-1.jpg}
\caption{Diagrama UML de diseño para la iteración 2}
\label{fig:diseno02}
\end{center}
\end{figure}
...
\section{Despliegue}
Se han realizado despliegues recurrentes durante el desarrollo del proyecto aunque por la casuística expuesta en la planificación el número de despliegues es considerablemente menor a la de la iteración 1, debido a que el trabajo de la iteración se va a replanificar en subsecuentes iteraciones.
