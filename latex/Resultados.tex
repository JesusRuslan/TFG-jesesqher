...
Las figuras~\ref{fig:smoothness_dijkstra}, \ref{fig:smoothness_astar} y \ref{fig:smoothness_all} muestran la irregularidad de la trayectoria, medida como el cambio de ángulo en valor absoluto acumulado en radianes, para cada objetivo y configuración.
