...
\item \textbf{Objetivo 6. Validación en robot real.}
Reproducir los experimentos realizados en simulación sobre el TurtleBot4 físico, generando previamente un mapa del entorno real mediante SLAM y comparando los resultados obtenidos en ambos entornos.

\item \textbf{Objetivo 7. Análisis comparativo.}
