...
\begin{enumerate}
\item Funcionalidad 1: Obtención de los datos de un usuario de un equipo. Ver Tabla \ref{tab:valor1AportadoItereacion6}.
\end{enumerate}
%----------------------------------------------------------------------------------------------------------
\begin{table*}[htb]
	\centering
...
\textbf{Propuesta}&Se pretende desarrollar la funcionalidad de obtener los datos de un usuario de un equipo.\\
\midrule
\textbf{Valor}&El valor aportado es poder visualizar los datos de un usuario de un equipo.\\
...
\textbf{Riesgos}&La no correcta visualización de los diferentes campos que tiene asociado un usuario de un equipo.\\
\textbf{Deuda técnica}&Se ha elegido la solución más factible para el desarrollo de la misma.\\
	\end{coolTable}
	\caption{Análisis de valor aportado 0001\label{tab:valor1AportadoItereacion6}}
\end{table*}
...
\section{Diseño}
Se ha realizado la eliminación de dos atributos para el modelo de Usuario logged y equipos, puesto que estos ya no eran necesarios, lo que se pretendía obtener con estos se obtienen con otras funcionalidades más eficientes.

Esto es comparable en la siguiente figura. \ref{fig:diseno06}.

\begin{figure}[htbp]
\begin{center}

\includegraphics[width=\textwidth]{figures/UML-iteracion-6.jpg}
\caption{Diagrama UML de diseño para la iteración 6}
\label{fig:diseno06}
\end{center}
\end{figure}
...
Se han realizado todas las pruebas de sistema a nivel de controlador y servicios, en mi caso he realizado las pruebas del servicio de tarea en su totalidad siendo el más complejo de todos los servicios, mientras que mi compañero Francisco José Anillo Carrasco ha realizado el resto (notificación, equipo, invitación y usuarios). En el caso de los controladores he realizado las pruebas de tareas, notificación e invitación mientras que mi compañero el de usuario y equipos. 
